...
void Slots(float &coins, float &casinoCasino) {
  // Uses this vector to output the right value
  ...
  while (flag) {
    ...
    cout << endl
         << "Would you like to spin? Input [1] to roll Hexadecimal slots. "
            "If you would like to exit, input [2]."
         << endl;
    string sChoice;
    cin >> sChoice;
    ...
    if (sChoice == "1") {
      ...
      if (slotComp[0] == slotComp[1] && slotComp[1] == slotComp[2]) {
        cout << endl
             << endl
             << "\033[1;32mCongratulations you just won " << bet * 200
...
int main() {
  float coins, casinoCoins;
  bool flag = true;
  while (flag) {

    // Asks for your coins
    cout << "\033[033mHow many coins do you have? You need atleast 15 to play!"
         << endl;
    cin >> coins;
    cout << "\033[0m" << endl;
